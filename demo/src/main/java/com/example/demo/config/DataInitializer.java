...
public class DataInitializer {
    ...
    public void initData() {
        ...
        if (deptos.size() >= 2) {
            // Usuario superadmin — tokenVersion ES determinista (no cambiar en cada restart,
            // sino reusar el valor existente si el usuario ya estaba creado).
            final int SUPERADMIN_TOKEN_VERSION = 1;
            ...
            final int ADMIN_TOKEN_VERSION = 2;
