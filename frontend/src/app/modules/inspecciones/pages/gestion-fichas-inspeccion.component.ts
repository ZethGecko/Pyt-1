          ...
          <tbody>
            <tr *ngFor="let ficha of fichas">
              ...
              <td>
                ...
                <td class="actions">
                  <button class="btn-icon btn-view" [routerLink]="['/inspecciones', 'ficha', ficha.id || ficha.idFichaInspeccion]" title="Editar ficha">
                   <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                   </svg>
                 </button>
                  <button class="btn-icon btn-view" [routerLink]="['/inspecciones', 'realizar', ficha.inspeccionId]" title="Ver detalle">
                   <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
